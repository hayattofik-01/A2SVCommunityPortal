...
class _LoginPageState extends State<LoginPage> {
  Widget _backButton() {
    return InkWell(
      ...
      child: Container(
        padding: EdgeInsets.symmetric(horizontal: UIConverter.getComponentWidth(context, 10)),
        child: Row(
          children: <Widget>[
            Container(
            ...
            Text('Back',
                style: TextStyle(fontSize:UIConverter.textSize(context, 12), fontWeight: FontWeight.w500))
          ],
        ),
      ),
    );
  ...
  Widget _submitButton() {
    return Container(
      ...
      child: Text(
        'Login',
        style: TextStyle(fontSize: UIConverter.textSize(context, 20), color: Colors.white),
      ),
    );
  }
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(
              ...
              style: TextStyle(fontSize: UIConverter.textSize(context, 16), fontWeight: FontWeight.w600),
            ),
            SizedBox(
            ...
            Text(
              ...
              style: TextStyle(
                  color:blue,
                  fontSize: UIConverter.getComponentWidth(context, 16),
  ...
  Widget _title() {
    ...
    crossAxisAlignment: CrossAxisAlignment.start,
      children: [
Text("Login", style: TextStyle(fontSize: UIConverter.textSize(context, 20), fontWeight: FontWeight.w600),),
_createAccountLabel(),
    ],);
  }
